...
import { Notification, Calendar, Box, ArrowRight, Wallet, People, Timer1, Add, Gallery, User, MagicStar, DocumentText, Ruler, Eye, EyeSlash, MoneyRecive, MoneySend, TickCircle } from 'iconsax-react-native';
    ...
    return (
        <View className={`flex-1 ${isDark ? 'bg-black' : 'bg-[#F2F2F7]'}`}>
            ...
            >
                ...
                {/* App Feature Banner: Catalog */}
                {catalogBannerVisible && (
                    <View className="mb-6">
                        <Pressable
                            onPress={() => router.push('/(tabs)/profile/catalog')}
                            style={{
                                backgroundColor: isDark ? '#1C1C1E' : '#111827',
                                borderRadius: 28,
                                padding: 20,
                        ...
                        >
                            <View className="flex-row items-center relative z-10">
                                <View className="w-12 h-12 rounded-[16px] bg-white/10 items-center justify-center mr-4">
                                    <Gallery size={20} color="#FFFFFF" variant="Bulk" />
                                </View>
                                <View className="flex-1 pr-6">
                                    <View className="flex-row items-center mb-1.5">
                                        <Typography variant="body" weight="bold" color="white" className="text-[15px] mr-2">Digital Storefront</Typography>
                                        <View className="bg-pink-500 px-1.5 py-0.5 rounded-md">
                                            <Typography variant="small" weight="bold" color="white" className="text-[9px] uppercase tracking-wider">New</Typography>
                                        </View>
                                    </View>
                                    <Typography variant="small" color="white" className="opacity-70 text-[12.5px] leading-[18px]">
                                        Publish your customized catalog link to your social media bios.
                                    </Typography>
                                </View>
                            </View>
                            ...
                            <Pressable
                                ...
                                className="absolute top-4 right-4 bg-white/10 w-6 h-6 rounded-full items-center justify-center z-20"
                            >
                                <Typography color="white" className="text-[10px] opacity-80 mt-[-1px]" weight="bold">✕</Typography>
                            </Pressable>

                            {/* Sleek Background Glow Effect */}
                            <View className="absolute -bottom-10 -right-10 w-32 h-32 bg-pink-500/20 rounded-full blur-3xl" />
                            <View className="absolute -top-10 -left-10 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl" />
                        </Pressable>
                    </View>
                )}
