...
import { Setting2, ArrowRight, User, Gallery, MessageQuestion, Logout } from 'iconsax-react-native';
            ...
            <ScrollView contentContainerClassName="p-6 pb-12" showsVerticalScrollIndicator={false}>
                ...
                <Surface variant="lavender" className="flex-row items-center p-6 mb-6" rounded="3xl">
                    ...
                    <View className="flex-1">
                        ...
                        <View className="bg-white/50 self-start px-3 py-1 rounded-full">
...
function ProfileItem({ icon, title, subtitle, badge }: ProfileItemProps) {
    return (
        <Pressable className="active:opacity-75">
            <Surface variant="white" className="p-4 bg-muted/50" rounded="2xl">
